...
parser.add_argument('--devicetree1g', dest='devicetree1g_file', required=True, type=str,
                    help='set the devicetree1g.dtb file path')
parser.add_argument('--devicetree512m', dest='devicetree512m_file', required=True, type=str,
                    help='set the devicetree512m.dtb file path')
...
if __name__ == '__main__':
    images = {
        ...
        "devicetree1g.dtb": options.devicetree1g_file,
        "devicetree512m.dtb": options.devicetree512m_file,
